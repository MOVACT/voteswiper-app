...
class ElectionQuestioninfo extends React.Component {
  render() {
    const { question, explainer_text, title } = this.props.navigation.state.params;
    return (
      <Container noPadding>
            ...
            <View style={styles.container}>
              <ScrollView style={{ marginTop: 10 }}>
                <View style={styles.explainerContent}>
                  <Title h5 center uppercase>{title}</Title>
                  <Title mainBig style={{ color: '#fff', textAlign: 'center' }} center>{question}</Title>
