...
import Svg, {Defs, Rect, Path, G, Mask, Use, SvgProps} from 'react-native-svg';
/* SVGR has dropped some elements not supported by react-native-svg: filter */

const SvgDe: React.FC<SvgProps> = (props) => (
  <Svg width={42} height={30} viewBox="0 0 42 30" {...props}>
    ...
    <G fill="none" fillRule="evenodd">
      ...
      <G mask="url(#de_svg__b)">
        <Use fill="#000" xlinkHref="#de_svg__d" />
        <Use fill="#F01515" xlinkHref="#de_svg__d" />
      </G>
      <G mask="url(#de_svg__b)">
        <Use fill="#000" xlinkHref="#de_svg__f" />
